...
import {
  Building2, Gavel, FileText, MessageSquare, Megaphone,
  BarChart3, Users, ClipboardList, AlertCircle, Star,
  LogOut, Menu, X, Globe, LayoutDashboard, FolderOpen,
} from 'lucide-react';
...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const navItems = user?.role === 'ADMIN' ? adminNav : user?.role === 'EMPLOYEE' ? employeeNav : citizenNav;
    ...
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-sidebar-foreground">{t('app.title')}</span>
        </div>
      </div>
